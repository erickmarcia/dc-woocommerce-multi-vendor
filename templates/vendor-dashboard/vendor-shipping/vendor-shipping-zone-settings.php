...
<div class="zone-component panel-content-padding">
	<div class="shipping-zone-list">
		<p><a href="javascript:void(0);" >&larr; <?php  _e('Shipping Zones', 'dc-woocommerce-multi-vendor'); ?></a></p>
		<hr>
	</div>
	...
	<div class="wcmp-zone-method-wrapper form-group mt-10">
		<div class="wcmp-zone-method-heading col-sm-3 col-md-3">
			<h2><?php _e( 'Shipping methods', 'dc-woocommerce-multi-vendor' ); ?></h2> 
			<span><?php _e( 'Add your shipping method for appropiate zone', 'dc-woocommerce-multi-vendor' ); ?></span> 
