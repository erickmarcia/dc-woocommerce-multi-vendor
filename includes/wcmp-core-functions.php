...
//                }
		...
		PRIMARY KEY (`ans_ID`),
            ...
            if (version_compare($previous_plugin_version, '3.2.1', '<=')) {
                ...
                if(!get_option('wcmp_321_vendor_shipping_data_migrated')){
                    $vendors = get_wcmp_vendors();
                    ...
                    if ($vendors) {
                                ...
                                foreach ($raw_methods as $raw_method) {
                                    if ($raw_method->id == 'flat_rate' && isset($raw_method->instance_form_fields["class_cost_" . $shipping_class_id])) {
                                        ...
                                        if($instance_settings){
                                            ...
                                            doProductVendorLOG('added vendor zone'.$instance_id);
                                            $data = array(
                                                'zone_id'   => $raw_zone['id'],
                        ...
                        update_option('wcmp_321_vendor_shipping_data_migrated', true);
                    }
                }
            }
